...
\begin{frame}
\frametitle{Characteristics of the Correct Solutions}
\begin{itemize}
\item<2-> \textit{Decentralized Policy} ---
\item<3-> \textit{Infrastructure Reuse} --- Multiple compartments on same HW
\item<4-> \textit{Cloud Integration} ---
\item<5-> \textit{Security in Depth} ---
\end{itemize}
\end{frame}
